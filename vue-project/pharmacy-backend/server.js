console.log('Server.js file loading...');
...
// Proxy category requests to category service
const { createProxyMiddleware } = require('http-proxy-middleware');
console.log('Proxy middleware for /api/categories initialized');
app.use('/api/categories', createProxyMiddleware({
  target: process.env.CATEGORY_SERVICE_URL || 'http://localhost:5001',
  changeOrigin: true,
  onError: (err, req, res) => {
